...
<table class='tg' id="tablaBuscar"style='width:95%'>
	...
	%>	
				<tr>
					    ...
					    <td><input type='button' id='productoSeleccionado' name='productoSeleccionado' value='Aprobar' onclick="mostrarProductos(<%=producto.getCodigo_pro()%>,'<%=producto.getNombre()%>',<%=producto.getPrecio()%>,<%=producto.getIva()%>)"></td>
				</tr>			 
		   	<% }
		}
		%>	
